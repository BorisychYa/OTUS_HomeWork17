...
Процедура ПоказатьСообщениеПоляФормыСвязанногоСРеквизитомОбъектаНаКлиенте(Команда)
	...
	ОбщегоНазначенияКлиент.СообщитьПользователю(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Пример сообщения, связанного с реквизитом объекта (%1).';
				|en = 'Sample of a message connected to an object attribute (%1).'"), "Объект.РеквизитОбъекта"), ,
...
Процедура ПоказатьСообщениеПоляФормыСвязанногоСРеквизитомФормыНаКлиенте(Команда)
	...
	ОбщегоНазначенияКлиент.СообщитьПользователю(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Пример сообщения, связанного с реквизитом формы (%1).';
				|en = 'Sample of a message connected to a form attribute (%1).'"), "РеквизитФормы"), ,
			"РеквизитФормы");
