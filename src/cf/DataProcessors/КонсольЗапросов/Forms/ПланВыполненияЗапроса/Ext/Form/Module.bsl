...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru = 'План выполнения запроса (';
					|en = 'Query plan ('") + Параметры.ИмяЗапроса + ")";
...
Функция НайтиМаксимальныйПоказательСтоимости(СтрокиДерева, Максимум = 0)
	...
	Для каждого СтрокаДерева Из СтрокиДерева Цикл
		Если СтрокаДерева.Строки.Количество() > 0 Тогда
			Максимум = НайтиМаксимальныйПоказательСтоимости(СтрокаДерева.Строки, Максимум);
		КонецЕсли;
		Если СтрокаДерева.Стоимость > Максимум Тогда
			Максимум = СтрокаДерева.Стоимость;
		КонецЕсли;
	КонецЦикла;
