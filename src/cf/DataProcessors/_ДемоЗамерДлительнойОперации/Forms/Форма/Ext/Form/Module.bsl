...
Функция НачатьВыполнениеНаСервере()
	...
	ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1 Начало выполнения...';
																										|en = '%1 Starting...'"), ТекущаяДатаСеанса()));
