...
Функция СформироватьПечатнуюФормуАктСписанияТоваров(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	Документ_ДемоСписаниеТоваров.Ссылка КАК Ссылка,
	|	Документ_ДемоСписаниеТоваров.Номер КАК Номер,
	|	Документ_ДемоСписаниеТоваров.Дата КАК Дата,
	|	Документ_ДемоСписаниеТоваров.МестоХранения КАК Склад,
	|	Документ_ДемоСписаниеТоваров.Организация КАК Организация,
	|	ПРЕДСТАВЛЕНИЕ(Документ_ДемоСписаниеТоваров.МестоХранения) КАК СкладПредставление,
	|	Документ_ДемоСписаниеТоваров.Организация.Наименование КАК ОрганизацияПредставление,
	|	Документ_ДемоСписаниеТоваров.Организация.Префикс КАК Префикс,
	|	Документ_ДемоСписаниеТоваров.МестоХранения.МОЛ КАК Кладовщик,
	|	Документ_ДемоСписаниеТоваров.Ответственный КАК Ответственный
	|ИЗ
	|	Документ._ДемоСписаниеТоваров КАК Документ_ДемоСписаниеТоваров
	|ГДЕ
	|	Документ_ДемоСписаниеТоваров.Ссылка В(&МассивОбъектов)
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка
	|;
