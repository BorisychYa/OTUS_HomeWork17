...
Процедура СформироватьДвиженияВРеестрДокументов()
	...
	Движение.Дополнительно = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'По договору ""%1""';
...
Процедура СформироватьДвижениеУчетаНачисленногоНДСПоРегиструОсновной(Знач СтрокаТовара, Знач ВидыНоменклатуры)
	...
	Значения.Вставить("Содержание", "ru = 'Реализация товаров';
									|en = 'Goods sales'"); // @НСтр-2
