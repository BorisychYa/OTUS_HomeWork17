...
Процедура ПрочитатьОсновныеНастройки(Параметры)
	...
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ОбщиеМодули", НСтр("ru = 'Общие модули';
																		|en = 'Common modules'"), НСтр("ru = 'Общий модуль';
																									|en = 'Common module'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ОбщиеФормы", НСтр("ru = 'Общие формы';
																		|en = 'Common forms'"), НСтр("ru = 'Общая форма';
																									|en = 'Common form'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ПланыОбмена", НСтр("ru = 'Планы обмена';
																		|en = 'Exchange plans'"), НСтр("ru = 'План обмена';
																									|en = 'Exchange plan'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Справочники", НСтр("ru = 'Справочники';
																		|en = 'Catalogs'"), НСтр("ru = 'Справочник';
																									|en = 'Catalog'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Документы", НСтр("ru = 'Документы';
																	|en = 'Documents'"), НСтр("ru = 'Документ';
																								|en = 'Document'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ЖурналыДокументов", НСтр("ru = 'Журналы документов';
																			|en = 'Document journals'"), НСтр("ru = 'Журнал документов';
																												|en = 'Document journal'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Отчеты", НСтр("ru = 'Отчеты';
																	|en = 'Reports'"), НСтр("ru = 'Отчет';
																						|en = 'Report'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Обработки", НСтр("ru = 'Обработки';
																	|en = 'Data processors'"), НСтр("ru = 'Обработка';
																								|en = 'Data processor'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ПланыВидовХарактеристик", НСтр("ru = 'Планы видов характеристик';
																					|en = 'Charts of characteristic types'"), НСтр("ru = 'План видов характеристик';
																															|en = 'Chart of characteristic types'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ПланыСчетов", НСтр("ru = 'Планы счетов';
																		|en = 'Charts of accounts'"), НСтр("ru = 'План счетов';
																									|en = 'Chart of accounts'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "ПланыВидовРасчета", НСтр("ru = 'Планы видов расчета';
																			|en = 'Charts of calculation types'"), НСтр("ru = 'План видов расчета';
																												|en = 'Chart of calculation types'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "РегистрыСведений", НСтр("ru = 'Регистры сведений';
																			|en = 'Information registers'"), НСтр("ru = 'Регистр сведений';
																												|en = 'Information register'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "РегистрыНакопления", НСтр("ru = 'Регистры накопления';
																				|en = 'Accumulation registers'"), НСтр("ru = 'Регистр накопления';
																													|en = 'Accumulation register'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "РегистрыБухгалтерии", НСтр("ru = 'Регистры бухгалтерии';
																				|en = 'Accounting registers'"), НСтр("ru = 'Регистр бухгалтерии';
																													|en = 'Accounting register'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "РегистрыРасчета", НСтр("ru = 'Регистры расчета';
																			|en = 'Calculation registers'"), НСтр("ru = 'Регистр расчета';
																											|en = 'Calculation register'"), Ложь);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "БизнесПроцессы", НСтр("ru = 'Бизнес-процессы';
																			|en = 'Business processes'"), НСтр("ru = 'Бизнес-процесс';
																											|en = 'Business process'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Задачи", НСтр("ru = 'Задачи';
																	|en = 'Tasks'"), НСтр("ru = 'Задача';
																						|en = 'Task'"), Истина);
	ЗарегистрироватьКоллекциюМетаданных(Параметры, "Роли", НСтр("ru = 'Роли';
																|en = 'Roles'"), НСтр("ru = 'Роль';
																					|en = 'Role'"), Ложь);
