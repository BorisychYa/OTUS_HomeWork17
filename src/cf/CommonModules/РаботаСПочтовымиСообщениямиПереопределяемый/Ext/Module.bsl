...
Процедура ПослеОтправкиПисьма(ПараметрыПисьма) Экспорт
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Работа с почтовыми сообщениями.После отправки письма';
										|en = 'Email management.After message sent'", ОбщегоНазначения.КодОсновногоЯзыка()),
