				...
				Для Каждого НастройкаСтавки Из ВариантыПоСтавкам Цикл
					Для Каждого НастройкаНомера Из ВариантыПоНомерам Цикл
						...
						Если Не ЗначениеЗаполнено(Организация) Тогда
							...
							Адрес.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(НСтр("ru = 'г.Москва, Дмитровское шоссе, д.9';
																															|en = 'Moscow, Dmitrovskoye Highway, 9'"), Адрес.Вид);
...
Процедура СоздатьЗаписиВРегистреСведенийЗаведующиеМестамиХранения(Настройки, Результат)
	...
	Наименование = НСтр("ru = 'Склад';
						|en = 'Warehouse'") + Суффикс;
