...
Процедура ПередВыгрузкойТипа(Контейнер, Сериализатор, ОбъектМетаданных, Отказ) Экспорт
	...
	ПроверитьНаличиеДублейЕстественныхКлючей(Контейнер, ОбъектМетаданных, ПоляЕстественногоКлюча);
...
//
Процедура ПроверитьНаличиеДублейЕстественныхКлючей(Знач Контейнер, Знач ОбъектМетаданных, Знач ПоляЕстественногоКлюча)
	...
	Контейнер.ДобавитьПредупреждение(ТекстСообщения);
