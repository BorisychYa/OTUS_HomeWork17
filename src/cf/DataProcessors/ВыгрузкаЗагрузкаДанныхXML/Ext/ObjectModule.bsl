		...
		Если Не ЗначениеПрочитано Тогда
			...
			Исключение
				ИмяСобытия = НСтр("ru = 'Обмен данными';
									|en = 'Data exchange'", КодОсновногоЯзыка());
