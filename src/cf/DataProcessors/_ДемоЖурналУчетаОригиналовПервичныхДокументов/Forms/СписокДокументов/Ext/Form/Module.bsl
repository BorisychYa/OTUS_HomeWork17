...
Процедура УстановитьИнтервалЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	Если Не ВыбранноеЗначение = Неопределено Тогда 	
		УстановитьЗаголовок(ВыбранноеЗначение);
...
&НаСервере
Процедура УстановитьЗаголовок(ВыбранноеЗначение)

	ТекстЗаголовка = ОбщегоНазначения.ПредставлениеСписка(Метаданные.Обработки._ДемоЖурналУчетаОригиналовПервичныхДокументов)+ " ";
	Значения = Новый Структура("ДатаНачала, ДатаОкончания",Формат(ВыбранноеЗначение.ДатаНачала,НСтр("ru = 'ДФ=dd.MM.yy';
																									|en = 'DF=MM/dd/yy'")), Формат(ВыбранноеЗначение.ДатаОкончания,НСтр("ru = 'ДФ=dd.MM.yy';
																																										|en = 'DF=MM/dd/yy'")));
...
Процедура УстановитьОтборПоВидуДокумента(Результат)
	...
	Если ЗначениеЗаполнено(Результат) Тогда
		...
		Если ОтборВидыДокументов.Количество() = КоличествоДокументов Или ОтборВидыДокументов.Количество()= 0 Тогда
			Элементы.ИнформационнаяНадписьОтбор.Заголовок = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru = 'Показаны все документы журнала <a href=""%1"">Настроить</a>';
																										|en = 'All log documents are shown <a href=""%1"">Configure</a>'"),"НастроитьОтбор");
		Иначе	
			...
			|%1 log documents are shown'"),ОтборВидыДокументов.Количество());
			Элементы.ИнформационнаяНадписьОтбор.Заголовок = СтроковыеФункции.ФорматированнаяСтрока(ТекстНадписи + " " +НСтр("ru = '<a href=""%1"">Настроить</a>';
																															|en = '<a href=""%1"">Configure</a>'"),"НастроитьОтбор");	
		КонецЕсли;
