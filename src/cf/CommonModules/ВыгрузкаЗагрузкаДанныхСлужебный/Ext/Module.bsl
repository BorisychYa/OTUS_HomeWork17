...
Процедура ОтправитьСообщениеВРодительскийПоток(ИдентификаторПроцесса, ИмяМетода, ДанныеСообщения) Экспорт
	...
	Сообщение.ИдентификаторНазначения = ИдентификаторПроцесса;
...
Процедура ОбработатьСообщенияПотоков(ТаблицаСообщений, Контейнер)
	...
	ТаблицаСообщений.Сортировать("ДатаОтправки");
...
Процедура ПолучитьСообщенияПотока(ТаблицаСообщений, Задание, ИдентификаторПроцесса)
	...
	Для Каждого Сообщение Из СообщенияПотока Цикл
		...
		ЗаполнитьЗначенияСвойств(ТаблицаСообщений.Добавить(), СообщениеПотока);
...
Функция НоваяТаблицаСообщенийПотоков()
	...
	ТаблицаСообщений.Колонки.Добавить("ДатаОтправки");
	ТаблицаСообщений.Колонки.Добавить("ИмяМетода");
