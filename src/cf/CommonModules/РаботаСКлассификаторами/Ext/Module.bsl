...
Функция ЗагрузитьФайлыКлассификаторов(ДанныеКлассификаторов, ДанныеАутентификации)
	...
	Для Каждого ОписательКлассификатора Из ДанныеКлассификаторов Цикл
		...
		Если ОписательКлассификатора.Размер = 0 Тогда
			ПараметрыОтправки.Таймаут = 30;
		Иначе
			...
			ПараметрыОтправки.Таймаут = ОписательКлассификатора.Размер / 1024 /1024 *128;
			Если ПараметрыОтправки.Таймаут > 43200 Тогда
				ПараметрыОтправки.Таймаут = 43200;
			ИначеЕсли ПараметрыОтправки.Таймаут < 30 Тогда
				ПараметрыОтправки.Таймаут = 30;
			КонецЕсли;
		КонецЕсли;
