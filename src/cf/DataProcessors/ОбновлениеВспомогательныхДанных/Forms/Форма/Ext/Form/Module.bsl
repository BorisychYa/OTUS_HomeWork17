...
Процедура ЗаполнитьЗаголовкиИПодсказки()
	...
	Элементы.СвойстваВидовДоступа.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Данные из процедуры %1';
			|en = '%1 procedure data'"), "ПриЗаполненииВидовДоступа");
	...
	Элементы.ОписаниеПоставляемыхПрофилейГруппДоступа.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Данные из процедуры %1';
			|en = '%1 procedure data'"), "ПриЗаполненииПоставляемыхПрофилейГруппДоступа");
	...
	Элементы.ОписаниеВозможныхПравДляНастройкиПравОбъектов.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Данные из процедуры %1';
			|en = '%1 procedure data'"), "ПриЗаполненииВозможныхПравДляНастройкиПравОбъектов");
