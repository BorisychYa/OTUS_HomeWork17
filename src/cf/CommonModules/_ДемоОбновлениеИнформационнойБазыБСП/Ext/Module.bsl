...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение служебных реквизитов Фамилия, Имя, Отчество в справочнике ""Демо: Физические лица"",
		...
		|en = 'Fill the First name, Middle name, and Last name service attributes in the Demo: Individuals catalog.
		|The attributes demonstrate applied parameters of an email subject and text upon the report distribution.
		|Report distribution emails with these parameters will not be completely filled until processing is completed.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Регистрация партнеров для расчета сроков хранения персональных данных.';
									|en = 'Register partners to calculate retention periods of personal data.'");
	// Конец Локализация
...
Процедура ПриНачальномЗаполненииВидовКонтактнойИнформации(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
			...
			|en = '""Partner contacts"" catalog contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
			...
			|en = 'Contact person address'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = 'Contact person''s email'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
			...
			|en = '""Demo: Companies"" catalog contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = 'Registered address'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = 'Business address'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Почтовый адрес';
		|en = 'Postal address'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = 'Address for payments'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = '""Partners"" catalog contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = 'Partner email'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = '""Counterparties"" catalog contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Мессенджеры';
		|en = 'Messengers'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = '""Demo: Individuals"" catalog contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = '""Sales order"" document contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		...
		|en = '""Partners and contacts"" table contact information'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Адрес партнера';
		|en = 'Partner address'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Телефон партнера';
		|en = 'Partner phone'", КодыЯзыков); // @НСтр-1
...
Процедура ПриНачальномЗаполненииШаблоновСообщений(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Уведомление о выставленном счете';
								|en = 'Issued invoice notification'", ОбщегоНазначения.КодОсновногоЯзыка());
	Элемент.Код = "000000002";
	Элемент.Назначение = НСтр("ru = 'Демо: Счет на оплату покупателю';
								|en = 'Demo: Sales proforma invoice'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Элемент.ТемаПисьма = НСтр("ru = 'Выставлен счет №[%1] от [%2]';
								|en = 'Issued invoice No. [%1] from [%2]'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	ЭлементТЧ.Имя           = НСтр("ru = 'Счет';
									|en = 'Account'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ПриНачальномЗаполненииЭлементаШаблоновСообщений(Объект, Данные, ДополнительныеПараметры) Экспорт
	...
	Если Объект.Код = "000000002" И Объект.Ссылка = Справочники.ШаблоныСообщений.ПустаяСсылка() Тогда
		...
		ИмяСобытияЖурналаРегистрации = НСтр("ru = 'Шаблоны сообщений: создание поставляемых шаблонов';
											|en = 'Message templates: Create 1C-supplied templates'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИмяБезРасширения = НСтр("ru = 'Инструкция по созданию факсимильной подписи и печати';
								|en = 'Facsimile instruction'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ОперативныйОбработчик() Экспорт
	...
	Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Демо: Выполнен оперативный обработчик ""%1"".';
			|en = 'Demo: Real-time handler %1 is executed.'"), "ОперативныйОбработчик");
	Сообщение.Сообщить();
...
Процедура ОбновитьПредопределенныеКлючевыеОперации() Экспорт
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'ЗаписьПредопределенныхКлючевыхОпераций';
										|en = 'PredefinedKeyOperationsRecord'", ОбщегоНазначения.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,,, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ВызватьИсключение;
	КонецПопытки;
...
Процедура ПерейтиСБазовойВерсииНаПРОФ() Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Выполнен обработчик перехода %1';
							|en = 'Migration handler %1 is executed.'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура НастроитьИсториюКонтактнойИнформацииИМногострочноеПоле() Экспорт
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'ВидыКонтактнойИнформации';
										|en = 'ContactInformationKinds'", ОбщегоНазначения.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ВызватьИсключение;
	КонецПопытки;
