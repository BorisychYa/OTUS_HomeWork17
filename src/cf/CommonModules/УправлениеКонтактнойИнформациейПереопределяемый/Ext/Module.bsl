...
Процедура ПриПолученииНаименованийВидовКонтактнойИнформации(Наименования, КодЯзыка) Экспорт
	...
	Наименования["_ДемоАдресКонтактногоЛица"] = НСтр("ru = 'Адрес контактного лица';
													|en = 'Contact person address'", КодЯзыка);
	Наименования["_ДемоEmailКонтактногоЛица"] = НСтр("ru = 'Электронная почта контактного лица';
													|en = 'Contact person''s email'", КодЯзыка);
	Наименования["Справочник_ДемоКонтактныеЛицаПартнеров"] = НСтр("ru = 'Контактная информация справочника ""Контактные лица партнеров""';
																	|en = '""Partner contacts"" catalog contact information'", КодЯзыка);
