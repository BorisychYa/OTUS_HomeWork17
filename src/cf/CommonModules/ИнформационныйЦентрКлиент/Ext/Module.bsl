...
Процедура ОткрытьФормуОтправкиСообщенияВСлужбуПоддержки(СоздаватьОбращение, 
	ИдентификаторОбращения = Неопределено, КодПользователя = Неопределено, ПараметрыСообщения = Неопределено) Экспорт
	...
	Если ПараметрыСообщения <> Неопределено Тогда
		ПараметрыФормы.Вставить("Вложения", ПараметрыСообщения.Вложения);
		ПараметрыФормы.Вставить("Тема", ПараметрыСообщения.ТемаСообщения);
		ПараметрыФормы.Вставить("Содержание", ПараметрыСообщения.Сообщение);
		ОповещениеОЗакрытии = ПараметрыСообщения.ОбработчикЗавершения;
	КонецЕсли;
...
// Конструктор параметров для создания сообщения в службу поддержки.
// 
// Возвращаемое значение:
...
//   ** ИмяФайла - Строка
//   ** Данные - Строка - адрес файла во временном хранилище. 
// * ОбработчикЗавершения - ОписаниеОповещения - обработчик закрытия формы сообщения.
//
Функция ПараметрыСообщения() Экспорт
	
	ПараметрыСообщения = Новый Структура;
	ПараметрыСообщения.Вставить("ТемаСообщения", "");
	ПараметрыСообщения.Вставить("Сообщение", "");
	ПараметрыСообщения.Вставить("Вложения", Новый Массив);
	ПараметрыСообщения.Вставить("ОбработчикЗавершения");
