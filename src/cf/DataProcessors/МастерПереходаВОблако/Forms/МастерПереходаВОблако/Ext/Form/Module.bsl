...
Функция ЗаголовокВход()
	...
	Возврат СтрШаблон(НСтр("ru = 'Шаг 1 из %1: Вход в облачный сервис';
							|en = 'Step 1 out of %1: Logging in to the cloud service'"), ВсегоШаговМастера());
