...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Запрос.Текст =
		...
		|	И ДополнительныеРеквизиты.Свойство.ВидСвойств В (ЗНАЧЕНИЕ(Перечисление.ВидыСвойств.ПустаяСсылка),
		...
		|ГДЕ
		|	Метки.Ссылка = &Ссылка
		|	И Метки.Свойство.ВидСвойств = ЗНАЧЕНИЕ(Перечисление.ВидыСвойств.Метки)
		|
		|УПОРЯДОЧИТЬ ПО
		|	Свойство";
